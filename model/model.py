...
class DINOv2Model(Model):
    def __init__(self, num_classes,  patch_size=16, embed_dim=384, depth=12, num_heads=6, mlp_ratio=4, num_experts=3, returns_feat=True, expert_start_layer=10, pretrained_path=None):
